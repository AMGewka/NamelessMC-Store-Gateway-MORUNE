...
if (Input::exists()) {
    if (Token::check()) {
        ...
        $settings = [
            'MORUNE/shopuuid_key' => $_POST['shopuuid_key'],
            'MORUNE/secret1_key' => $_POST['secret1_key'],
            'MORUNE/secret2_key' => $_POST['secret2_key'],
            'MORUNE/morune_callb' => $_POST['morune_callb'],
            'MORUNE/morune_apiurl' => $_POST['morune_apiurl']
        ];
